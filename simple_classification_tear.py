...
ie = Core()
model = ie.read_model(model="model/model_tear_cls_eff_v2_s.xml")
...
#image = cv2.imread(filename="images/tear_01.jpg")
image = cv2.imread(filename="images/tear_02.jpg")
#image = cv2.imread(filename="images/tear_03.jpg")
#image = cv2.imread(filename="images/tear_04.jpg")
